export const en = {
    ...
    'trial.success': {
        button: 'Go to Control Panel',
        trialTitle: 'Welcome to the Free Trial!',
        trialSubtitle: 'Your account has been successfully created with the trial period.',
        trialSteps: 'Get started today:',
        trialStep1: 'Explore all premium features.',
        trialStep2: 'Set up your tables and categories.',
        trialStep3: 'Upload your first dishes.',
        trialMessage: 'Enjoy your 7 free days!',
        trialButton: 'Go to my Restaurant'
    },
    ...
    'pricing.starter.name': 'Basic Plan',
    'pricing.professional.name': 'Professional Plan',
    'pricing.enterprise.name': 'Enterprise Plan',
    'settings.sub.status.trial_days': '{days} trial days remaining',
    'settings.sub.status.trial_expired': 'Free trial expired',
    'settings.sub.blocked.title': 'Subscription Required',
    'settings.sub.blocked.description': 'Your trial period has ended or your subscription needs attention. Please upgrade your plan to continue using all features.',
    'settings.sub.blocked.button': 'Go to Subscription',
    ...
    'modal.upgrade.title': 'Upgrade Plan',
    'modal.upgrade.current': 'Current',
    'modal.upgrade.downgradeError': 'You cannot downgrade for the following reasons:',
    'modal.upgrade.removeUsers': 'You must remove {count} users to meet the limit.',
    'modal.upgrade.removeTables': 'You must remove {count} tables to meet the limit.',
    'modal.upgrade.success': 'Plan updated successfully!',
    'modal.upgrade.immediateDesc': 'Your plan has been updated immediately. You can now enjoy your new limits.',
    'settings.sub.pendingChangeDesc': 'Your request has been registered. The plan change and new amount will be applied automatically on your next billing date. No charge has been made today.',
    'modal.processing': 'Processing...',
    'settings.plan.upgrade': 'Upgrade Plan',
    'settings.plan.activate': 'Activate Plan / Pay Now',
    ...
    'plan.feature.tables': 'Up to {count} tables',
    'plan.feature.users': 'Up to {count} users',
    ...
    'pricing.contact.title': 'Need something special?',
    'pricing.contact.subtitle': 'Contact us for a custom plan tailored to your business needs.',
    ...
    'settings.tables.title': 'Tables Management',
    ...
    'cashier.no_sales': 'No sales found for this period',
    'cashier.paid': 'Paid',
    ...
    'kitchen.confirm_complete_all': 'Complete all dishes?',
    ...
    'staff.tables.go_to_page': 'Go to Table',
    ...
    'bill.items_pending': 'Some items are still in the kitchen or pending service',
    ...
    'order_detail.has_notes': 'Has notes',
    'order_detail.stack': 'Stack',
    'order_detail.decouple': 'Decouple',
    ...
    'contact.subtitle': 'We are here to help. Send us a message and we will respond shortly.',
    ...
    'privacy.intro': 'At Hamelin Foods, we are committed to protecting your personal information and your right to privacy.',
    'privacy.section1.title': 'Information We Collect',
    'privacy.section1.content': 'We collect personal information that you provide to us, such as name, email, and restaurant data.',
    'privacy.section2.title': 'How We Use Your Information',
    'privacy.section2.content': 'We use your information to provide, operate, and maintain our services.',
    'privacy.section3.title': 'Data Protection',
    'privacy.section3.content': 'We implement security measures designed to protect the security of your personal information.',
    'privacy.section4.title': 'Your Rights',
    'privacy.section4.content': 'You have the right to access, rectify, or delete your personal information at any time.',
    'privacy.section5.title': 'Updates',
    'privacy.section5.content': 'We may update this policy periodically. We will notify you of significant changes.',
    'privacy.contact': 'If you have questions, contact us at support@hamelinfoods.com.',

    // Terms
    'terms.title': 'Terms and Conditions',
    'terms.subtitle': 'Rules for using our platform',
    'terms.intro': 'By using Hamelin Foods services, you agree to be bound by these terms.',
    'terms.section1.title': 'Use of Service',
    'terms.section1.content': 'You agree to use our platform in a legal and ethical manner.',
    'terms.section2.title': 'User Accounts',
    'terms.section2.content': 'You are responsible for maintaining the confidentiality of your account and password.',
    'terms.section3.title': 'Payments and Subscriptions',
    'terms.section3.content': 'Services are billed according to the selected plan. You can cancel at any time.',
    'terms.section4.title': 'Intellectual Property',
    'terms.section4.content': 'All content on the platform is the property of Hamelin Foods.',
    'terms.section5.title': 'Limitation of Liability',
    'terms.section5.content': 'We are not liable for any indirect damages arising from the use of the service.',
    'terms.section6.title': 'Termination',
    'terms.section6.content': 'We reserve the right to suspend accounts for violations of these terms.',
    'terms.section7.title': 'Governing Law',
    'terms.section7.content': 'These terms are governed by applicable laws.',
    'terms.contact': 'For questions, email support@hamelinfoods.com.',

    // About
    'about.title': 'About Us',
    'about.subtitle': 'Revolutionizing gastronomic management',
    'about.mission.title': 'Our Mission',
    'about.mission.content': 'Empower restaurants with intuitive technology that simplifies their daily operation.',
    'about.vision.title': 'Our Vision',
    'about.vision.content': 'To be the leading global platform for restaurant management.',
    'about.values.title': 'Our Values',
    'about.value1.title': 'Innovation',
    'about.value1.desc': 'Constantly seeking new ways to improve.',
    'about.value2.title': 'Commitment',
    'about.value2.desc': 'Dedicated to our customers\' success.',
    'about.value3.title': 'Integrity',
    'about.value3.desc': 'We act with transparency and honesty.',
    'about.value4.title': 'Quality',
    'about.value4.desc': 'Robust and reliable product.',

    // Success Page
    'success.title': 'Payment Confirmed!',
    'success.subtitle': 'Thank you for your visit. Your payment has been processed successfully.',
    'success.message': 'We hope you had an excellent experience with us.',
    'success.view_receipt': 'View Digital Receipt',
    'success.back_to_menu': 'Back to Menu',
