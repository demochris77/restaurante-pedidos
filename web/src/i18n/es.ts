export const es = {
    ...
    'plan.feature.tables': 'Hasta {count} mesas',
    'plan.feature.users': 'Hasta {count} usuarios',
    ...
    'plan.feature.fullCustomization': 'Personalización avanzada',

    'pricing.contact.title': '¿Necesitas algo especial?',
    'pricing.contact.subtitle': 'Contáctanos para un plan personalizado a la medida de tu negocio.',
    ...
    'payment.trial.title': '¡Bienvenido a la Prueba Gratis!',
    'payment.trial.subtitle': 'Tu cuenta ha sido creada exitosamente con el periodo de prueba.',
    'payment.trial.steps': 'Comienza hoy mismo:',
    'payment.trial.step1': 'Explora todas las funciones premium.',
    'payment.trial.step2': 'Configura tus mesas y categorías.',
    'payment.trial.step3': 'Sube tus primeros platos.',
    'payment.trial.message': '¡Disfruta de tus 7 días gratis!',
    'payment.trial.button': 'Ir a mi Restaurante',
    ...
    'modal.upgrade.current': 'Tu plan actual',
    ...
    'admin.menu.available': 'Disponible',
    ...
    'settings.sub.pendingChangeDesc': 'Tu solicitud ha sido registrada. El cambio de plan y el nuevo monto se aplicarán automáticamente en tu próxima fecha de facturación. No se ha realizado ningún cobro hoy.',
    ...
    'settings.sub.status.trial_days': '{days} días restantes de prueba',
    'settings.sub.status.trial_expired': 'Prueba gratuita expirada',
    'settings.sub.blocked.title': 'Suscripción requerida',
    'settings.sub.blocked.description': 'Tu periodo de prueba ha terminado o tu suscripción requiere atención. Por favor, actualiza tu plan para continuar usando todas las funciones.',
    'settings.sub.blocked.button': 'Ir a Suscripción',
    'settings.sub.status.trial': 'Prueba Gratuita',
    'settings.sub.status.active': 'Suscripción Activa',
    'settings.sub.status.past_due': 'Pago Pendiente',
    'settings.sub.status.blocked': 'Cuenta Bloqueada',
    'settings.sub.status.cancelled': 'Suscripción Cancelada',

    'modal.upgrade.title': 'Actualizar Plan',
    'modal.upgrade.downgradeError': 'No puedes bajar de plan por los siguientes motivos:',
    'modal.upgrade.removeUsers': 'Debes eliminar {count} usuarios para cumplir con el límite.',
    'modal.upgrade.success': '¡Plan actualizado con éxito!',
    'modal.upgrade.immediateDesc': 'Tu plan ha sido actualizado inmediatamente. Ya puedes disfrutar de tus nuevos límites.',
    'plan.feature.basicSupport': 'Soporte Básico',
    'settings.plan.activate': 'Activar Plan / Pagar Ahora',
    ...
    'cashier.no_sales': 'No se encontraron ventas para este período',
    'cashier.paid': 'Pagado',
    ...
    'kitchen.confirm_complete_all': '¿Completar todos los platos?',
    ...
    'staff.tables.go_to_page': 'Ir a Mesa',
    ...
    'bill.items_pending': 'Aún hay platos en cocina o por servir',
    ...
    'order_detail.has_notes': 'Tiene notas',
    'order_detail.stack': 'Apilar',
    'order_detail.decouple': 'Desacoplar',
    ...
    'privacy.intro': 'En Hamelin Foods, nos comprometemos a proteger tu información personal y tu derecho a la privacidad.',
    'privacy.section1.title': 'Información que Recopilamos',
    'privacy.section1.content': 'Recopilamos información personal que nos proporcionas, como nombre, correo electrónico y datos del restaurante.',
    'privacy.section2.title': 'Cómo usamos tu información',
    'privacy.section2.content': 'Utilizamos tu información para proporcionar, operar y mantener nuestros servicios.',
    'privacy.section3.title': 'Protección de Datos',
    'privacy.section3.content': 'Implementamos medidas de seguridad para proteger la seguridad de tu información personal.',
    'privacy.section4.title': 'Tus Derechos',
    'privacy.section4.content': 'Puedes acceder, rectificar o eliminar tu información en cualquier momento.',
    'privacy.section5.title': 'Actualizaciones',
    'privacy.section5.content': 'Podemos actualizar esta política periódicamente. Te notificaremos sobre cambios significativos.',
    'privacy.contact': 'Si tienes preguntas, contáctanos en support@hamelinfoods.com.',

    // Terms
    'terms.title': 'Términos y Condiciones',
    'terms.subtitle': 'Reglas de uso de nuestra plataforma',
    'terms.intro': 'Al usar los servicios de Hamelin Foods, aceptas quedar vinculado por estos términos.',
    'terms.section1.title': 'Uso del Servicio',
    'terms.section1.content': 'Aceptas usar nuestra plataforma de manera legal y ética.',
    'terms.section2.title': 'Cuentas de Usuario',
    'terms.section2.content': 'Eres responsable de la confidencialidad de tu cuenta y contraseña.',
    'terms.section3.title': 'Pagos y Suscripciones',
    'terms.section3.content': 'Los servicios se facturan según el plan seleccionado. Puedes cancelar en cualquier momento.',
    'terms.section4.title': 'Propiedad Intelectual',
    'terms.section4.content': 'Todo el contenido de la plataforma es propiedad de Hamelin Foods.',
    'terms.section5.title': 'Limitación de Responsabilidad',
    'terms.section5.content': 'No somos responsables de daños indirectos derivados del uso del servicio.',
    'terms.section6.title': 'Terminación',
    'terms.section6.content': 'Nos reservamos el derecho de suspender cuentas por violaciones a los términos.',
    'terms.section7.title': 'Ley Aplicable',
    'terms.section7.content': 'Estos términos se rigen por las leyes vigentes.',
    'terms.contact': 'Para dudas, escribe a support@hamelinfoods.com.',

    // About
    'about.title': 'Sobre Nosotros',
    'about.subtitle': 'Revolucionando la gestión gastronómica',
    'about.mission.title': 'Nuestra Misión',
    'about.mission.content': 'Empoderar a los restaurantes con tecnología intuitiva que simplifique su operación.',
    'about.vision.title': 'Nuestra Visión',
    'about.vision.content': 'Ser la plataforma líder global en gestión de restaurantes.',
    'about.values.title': 'Nuestros Valores',
    'about.value1.title': 'Innovación',
    'about.value1.desc': 'Buscamos constantemente nuevas formas de mejorar.',
    'about.value2.title': 'Compromiso',
    'about.value2.desc': 'Dedicados al éxito de nuestros clientes.',
    'about.value3.title': 'Integridad',
    'about.value3.desc': 'Actuamos con transparencia y honestidad.',
    'about.value4.title': 'Calidad',
    'about.value4.desc': 'Producto robusto y confiable.',
    
    // Success Page
    'success.title': '¡Pago Confirmado!',
    'success.subtitle': 'Gracias por tu visita. Tu pago ha sido procesado correctamente.',
    'success.message': 'Esperamos que hayas tenido una excelente experiencia con nosotros.',
    'success.view_receipt': 'Ver Recibo Digital',
    'success.back_to_menu': 'Volver al Inicio',
    'success.order_id': 'ID de Orden',
}
